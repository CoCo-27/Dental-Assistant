  ...
  return (
    ...
    >
      <div className="flex items-center w-full">
        <button
          className="text-sidebar text-black flex flex-shrink-0 cursor-pointer select-none items-center gap-3 rounded-md border border-black/20 p-3 transition-colors duration-200 hover:bg-gray-500/10"
          onClick={() => {
            handleCreateItem();
            handleSearchTerm('');
          }}
